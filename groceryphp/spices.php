...
// Query to get fruits
$sql = "SELECT item_id, item_name, price FROM ct_01_Subcategory_Items WHERE subcategory_id = 'FG-08'";
...
<head>
  ...
  <title>Spices & Condiments - MiniMall</title>

...
$sql = "SELECT item_id, item_name, price FROM ct_08_subcategory_items WHERE subcategory_id = 'HF-09'";
...
<head>
  ...
  <title>Weight Management Products - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Weight Management Products</h1>

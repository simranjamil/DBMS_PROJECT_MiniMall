...
$sql = "SELECT item_id, item_name, price FROM ct_08_subcategory_items WHERE subcategory_id = 'HF-07'";
...
<head>
  ...
  <title>Sports Gear & Equipment - MiniMall</title>

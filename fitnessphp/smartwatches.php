...
$sql = "SELECT item_id, item_name, price FROM ct_08_subcategory_items WHERE subcategory_id = 'HF-05'";
...
<head>
  ...
  <title>Smart Watches & Fitness Trackers - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Smart Watches & Fitness Trackers</h1>

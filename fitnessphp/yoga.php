...
$sql = "SELECT item_id, item_name, price FROM ct_08_subcategory_items WHERE subcategory_id = 'HF-02'";
...
<head>
  ...
  <title>Yoga & Meditation Essentials - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Yoga & Meditation Essentials</h1>

...
$sql = "SELECT item_id, item_name, price FROM ct_08_subcategory_items WHERE subcategory_id = 'HF-04'";
...
<head>
  ...
  <title>Supplements & Nutrition - MiniMall</title>

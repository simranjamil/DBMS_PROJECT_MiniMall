...
$sql = "SELECT item_id, item_name, price FROM ct_08_subcategory_items WHERE subcategory_id = 'HF-03'";
...
<head>
  ...
  <title>Fitness Apparel & Accessories - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Fitness Apparel & Accessories</h1>

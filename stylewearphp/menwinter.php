...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-G06'";
...
<head>
  ...
  <title>Men's Seasonal & Winter Wear - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Men's Seasonal & Winter Wear</h1>

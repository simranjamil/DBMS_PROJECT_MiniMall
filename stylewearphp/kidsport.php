...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-K03'";
...
<head>
  ...
  <title>Kid's Sportswear - MiniMall</title>

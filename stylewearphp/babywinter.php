...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-B03'";
...
<head>
  ...
  <title>Baby Seasonal & Winter Wear - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Baby Seasonal & Winter Wear</h1>

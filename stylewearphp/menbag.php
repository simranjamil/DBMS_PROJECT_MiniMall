...
// Query to get fruits
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-G07'";
...
<head>
  ...
  <title>Men's Bags & Wallets - MiniMall</title>

...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-L04'";
...
<head>
  ...
  <title>Women's Ethnic & Traditional Wear - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Women's Ethnic & Traditional Wear</h1>
  ...
  <nav class="back-home">
    <a href="../stylewear.php">← Back to Style & Wear</a>
  </nav>

...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-G04'";
...
<head>
  ...
  <title>Men's Ethnic & Traditional Wear - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Men's Ethnic & Traditional Wear</h1>

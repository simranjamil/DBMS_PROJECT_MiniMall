...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-L05'";
...
<head>
  ...
  <title>Women's Sportswear - MiniMall</title>

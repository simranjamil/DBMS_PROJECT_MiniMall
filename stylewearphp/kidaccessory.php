...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-K05'";
...
<head>
  ...
  <title>Kid's Accessories - MiniMall</title>

...
$sql = "SELECT item_id, item_name, price FROM ct_02_subcategory_items WHERE subcategory_id = 'SW-L07'";
...
<head>
  ...
  <title>Women's Bags & Wallets - MiniMall</title>

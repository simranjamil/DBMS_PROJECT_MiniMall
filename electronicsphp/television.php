...
$sql = "SELECT item_id, item_name, price FROM ct_03_subcategory_items WHERE subcategory_id = 'EL-04'";
...
<head>
  ...
  <title>Television & Home Entertainment - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Television & Home Entertainment</h1>
  ...
  <nav class="back-home">
    <a href="../electronics.php">← Back to Electronics</a>
  </nav>

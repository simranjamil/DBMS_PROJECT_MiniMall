...
$sql = "SELECT item_id, item_name, price FROM ct_03_subcategory_items WHERE subcategory_id = 'EL-09'";
...
<head>
  ...
  <title>Personal Care Electronics - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Personal Care Electronics</h1>

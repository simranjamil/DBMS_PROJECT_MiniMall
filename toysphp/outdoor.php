...
$sql = "SELECT item_id, item_name, price FROM ct_07_subcategory_items WHERE subcategory_id = 'TG-06'";
...
<head>
  ...
  <title>Outdoor Play Equipment - MiniMall</title>
...
<body>
  ...
  <nav class="back-home">
    <a href="../toys.php">← Back to Toys & Games</a>
  </nav>
</body>
</html>

...
$sql = "SELECT item_id, item_name, price FROM ct_07_subcategory_items WHERE subcategory_id = 'TG-04'";
...
<head>
  ...
  <title>Action Figures & Dolls - MiniMall</title>

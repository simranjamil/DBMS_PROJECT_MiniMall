...
$sql = "SELECT item_id, item_name, price FROM ct_07_subcategory_items WHERE subcategory_id = 'TG-02'";
...
<head>
  ...
  <title>Building Blocks & Sets - MiniMall</title>

...
$sql = "SELECT item_id, item_name, price FROM ct_04_subcategory_items WHERE subcategory_id = 'HL-03'";
...
<head>
  ...
  <title>Kitchenware & Cookware - MiniMall</title>

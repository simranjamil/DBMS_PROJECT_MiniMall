...
$sql = "SELECT item_id, item_name, price FROM ct_04_subcategory_items WHERE subcategory_id = 'HL-06'";
...
<head>
  ...
  <title>Bedding & Mattresses - MiniMall</title>

...
$sql = "SELECT item_id, item_name, price FROM ct_06_subcategory_items WHERE subcategory_id = 'BS-05'";
...
<head>
  ...
  <title>Self-help & Motivational - MiniMall</title>

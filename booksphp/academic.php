...
$sql = "SELECT item_id, item_name, price FROM ct_06_subcategory_items WHERE subcategory_id = 'BS-02'";
...
<head>
  ...
  <title>Educational & Academic Books - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Educational & Academic Books</h1>
  ...
  <nav class="back-home">
    <a href="../books.php">← Back to Books & Stationery</a>
  </nav>

...
$sql = "SELECT item_id, item_name, price FROM ct_06_subcategory_items WHERE subcategory_id = 'BS-03'";
...
<head>
  ...
  <title>Competitive Exam Books - MiniMall</title>

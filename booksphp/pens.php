...
$sql = "SELECT item_id, item_name, price FROM ct_06_subcategory_items WHERE subcategory_id = 'BS-10'";
...
<head>
  ...
  <title>Pens, Markers & Highlighters - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Pens, Markers & Highlighters</h1>

...
$sql = "SELECT item_id, item_name, price FROM ct_05_subcategory_items WHERE subcategory_id = 'BP-07'";
...
<head>
  ...
  <title>Beauty Tools & Accessories - MiniMall</title>
...
<body>
  ...
  <div class="container">
    <h1>Beauty Tools & Accessories</h1>
  ...
  <nav class="back-home">
    <a href="../beauty.php">← Back to Beauty</a>
  </nav>

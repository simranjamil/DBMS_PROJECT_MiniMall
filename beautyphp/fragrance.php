...
$sql = "SELECT item_id, item_name, price FROM ct_05_subcategory_items WHERE subcategory_id = 'BP-05'";
...
<head>
  ...
  <title>Perfumes & Fragrances - MiniMall</title>
